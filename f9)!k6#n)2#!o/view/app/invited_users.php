...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-6">
        Invited Users | for app id: <?php echo $id; ?> 
      </div>
      <div class="col-md-6">
  ...
  <script>
    function deleteUser(id){
      $.post("/app/delete_invited_user",{"_method":"delete","_token":"<?php echo $rand; ?>","app_id":"<?php echo $id; ?>","user_id":id}, function(data, status){
        if(status == 'success'){
          $('#r'+id).remove();
