...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-8">
        Public App List | <span id="active_app" style="text-align: center; word-break: break-all;">active app - id: <?php echo $active_app['id']; ?> name: <?php echo $active_app['name']; ?> secret: <?php echo $active_app['secret']; ?></span> </div>
      <div class="col-md-4">
