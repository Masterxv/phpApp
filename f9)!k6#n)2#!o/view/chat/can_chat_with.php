    ...
    <div class="col-md-3"></div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-12">
              <select id="group_chat" class="form-control"><?php foreach (array_merge(['-'],$ap) as $b): ?><option @empty($ccw['group_chat']) @else selected @endempty>{{$b}}</option><?php endforeach; ?></select>
            </div>
          </div>
        </div>      
      </div><hr>
