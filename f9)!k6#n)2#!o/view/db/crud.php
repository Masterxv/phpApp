	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="btn-group" style="float:right;">
				<a class="btn btn-default" href="/table/add_record_view?table=<?php echo $table; ?>">Add New Record</a>
...
<script>
  function d(id, table){
    $.post("/table/delete_record", {"_token":"<?php echo $rand; ?>", "id":id, "table":table}, function(data) {
